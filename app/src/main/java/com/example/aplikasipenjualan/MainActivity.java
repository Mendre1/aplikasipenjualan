...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aplikasi Penjualan Boba");
        ...
        btnProses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (total >= 200000) {
                    tvBonus.setText("Bonus : 2 sweetsugar boba");
                } else if (total >= 50000) {
                    tvBonus.setText("Bonus : 1 jasmientea boba");
                } else if (total >= 40000) {
                    tvBonus.setText("Bonus : extra keju topping");
                } else {
